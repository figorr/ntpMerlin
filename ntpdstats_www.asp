...
<td>
<input type="button" onclick="UpdateStats();" value="Actualizar stats" class="button_gen" name="btnUpdateStats" id="btnUpdateStats">
...
<td>
<input type="button" onclick="ExportCSV();" value="Exportar a CSV" class="button_gen" name="btnExport">
</td>
</tr>
</table>
...
<th width="40%">Modo Salida de Datos<br/><span style="color:#FFCC00;">(for gráficos semanales y mensuales)</span></th>
<td class="settingvalue">
<input type="radio" name="ntpmerlin_outputdatamode" id="ntpmerlin_dataoutput_average" class="input" value="media" checked>
...
<th width="40%">Ubicación Almacenamiento Datos</th>
<td class="settingvalue">
...
<tr><td colspan="2">Opciones Vista de Gráficos (click para expandir/contraer)</td></tr>
</thead>
<tr>
<th width="20%"><span style="color:#FFFFFF;">Formato de tiempo</span><br /><span style="color:#FFCC00;">(para informacion y eje últimas 24 horas)</span></th>
<td>
...
<input type="button" onclick="ToggleDragZoom(this);" value="Arrastrar Zoom" class="button_gen" name="btnDragZoom">
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<input type="button" onclick="ResetZoom();" value="Resetear Zoom" class="button_gen" name="btnResetZoom">
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<input type="button" onclick="ToggleLines();" value="Alternar Líneas" class="button_gen" name="btnToggleLines">
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<input type="button" onclick="ToggleFill();" value="Alternar Relleno" class="button_gen" name="btnToggleFill">
</td>
</tr>
</table>
<div style="line-height:10px;">&nbsp;</div>
...
<tr>
<td colspan="2">Jitter (click para expandir/contraer)</td>
</tr>
</thead>
<tr class="even">
<th width="40%">Período para mostrar</th>
